...
namespace ConsoleApp1
{
    public static class ThirdLecture
    {
        ...
        {
            FirstTaskFirstPart(101);
            FirstTaskSecondPart(7);
        ...
        private static void FirstTaskFirstPart(int inputNumber)
        {
        ...
        private static void FirstTaskSecondPart(int dayNumber)
        {
        ...
        {
            string productOneName = "orange";
            double productOnePrice = 0.49;

            string productTwoName = "milkshake";
            double productTwoPrice = 1.79;

            string productThreeName = "banana";
            double productThreePrice = 4.99;
            ...
            string basketProductOne = Console.ReadLine().Trim().ToLower();

            Console.WriteLine("Enter the name of the second product: ");
            string basketProductTwo = Console.ReadLine().Trim().ToLower();
            ...
            string cardResponse = Console.ReadLine().Trim().ToLower();
