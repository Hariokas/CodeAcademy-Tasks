...
public static class Lecture4
{
    ...
    {
        var monthName =
            new DateTime(DateTime.Now.Year, monthNumber, DateTime.Now.Day).ToString("MMMM",
    ...
    private static void Task_2_1()
    {
        ...
        switch (shapeName.ToLower().Trim())
        {
            case "square":
                ...
                var borderLength = double.Parse(Console.ReadLine());
                var squareArea = borderLength * borderLength;
            ...
            case "triangle":
                ...
                Console.WriteLine("What's the length of the border?:");
                var triangleBorder = double.Parse(Console.ReadLine());
                var triangleArea = 0.5 * triangleHeight * triangleBorder;
                Console.WriteLine($"Area of the triangle: {triangleArea}");
                break;

            case "rectangle":
                Console.WriteLine("What's the length of the short border?:");
                var shortBorder = double.Parse(Console.ReadLine());
                Console.WriteLine("What's the length of the long border?:");
                var longBorder = double.Parse(Console.ReadLine());
                var rectangleArea = shortBorder * longBorder;
